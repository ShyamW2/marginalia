 ...
 * movable and resizable like the annotation card, one row per hit, a row
 * click landing exactly where stepping to that index lands.
 *
            ...
            <li key={row.index} className={styles.item}>
              ...
              >
                ...
                <span className={styles.meta}>
                  <span className={styles.metaChapter}>{row.chapter ?? row.source}</span>
